 ...
 */
@Controller
@RequestMapping("/power/powerinfo2")
public class Powerinfo2Controller extends BaseController
{
    private String prefix = "power/powerinfo2";
	
	@Autowired
	private IPowerinfoService powerinfoService;
	
	@RequiresPermissions("power:powerinfo2:view")
	@GetMapping()
	 ...
	 * 查询电厂列表
	 */
	@RequiresPermissions("power:powerinfo2:list")
	@PostMapping("/list")
	@ResponseBody
	 ...
	 * 导出电厂列表
	 */
	@RequiresPermissions("power:powerinfo2:export")
    @PostMapping("/export")
    @ResponseBody
	 ...
	 * 新增保存电厂
	 */
	@RequiresPermissions("power:powerinfo2:add")
	 ...
	 * 修改保存电厂
	 */
	@RequiresPermissions("power:powerinfo2:edit")
	 ...
	 * 删除电厂
	 */
	@RequiresPermissions("power:powerinfo2:remove")
