 ...
 */
@Controller
@RequestMapping("/power/powernum2")
public class Powernum2Controller extends BaseController
{
    private String prefix = "power/powernum2";
	...
	@RequiresPermissions("power:powernum2:view")
	@GetMapping()
	 ...
	 * 查询电力公司列表
	 */
	@RequiresPermissions("power:powernum2:list")
	@PostMapping("/list")
	@ResponseBody
	 ...
	 * 导出电力公司列表
	 */
	@RequiresPermissions("power:powernum2:export")
    @PostMapping("/export")
    @ResponseBody
	 ...
	 * 新增保存电力公司
	 */
	@RequiresPermissions("power:powernum2:add")
	 ...
	 * 修改保存电力公司
	 */
	@RequiresPermissions("power:powernum2:edit")
	 ...
	 * 删除电力公司
	 */
	@RequiresPermissions("power:powernum2:remove")
